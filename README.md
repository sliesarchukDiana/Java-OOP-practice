...
1. Clone the repository:
   ```bash
   git clone https://github.com/sliesarchukDiana/Java-OOP-practice.git
2. Open the cloned folder in your IDE of choice (like IntelliJ IDEA, Eclipse, or VS Code).

3. Navigate to the specific .java file containing the main method for the task you want to test and click "Run".
